		...
		SubModules: []core.UISubModule{
			{
				...
				Components: []core.UIComponent{
					{
						Name:        "antiraid.alt_detector",
						Label:       arAltL,
						Description: arAltD,
						Type:        core.ComponentTypeBoolean,
					},
					{
						Name:        "antiraid.anti_bot",
						Label:       arBotL,
						Description: arBotD,
						Type:        core.ComponentTypeBoolean,
					},
					{
						Name:        "antiraid.anti_massjoin_level",
						Label:       arMassL,
						Description: arMassD,
			...
			},
			{
				...
				Components: []core.UIComponent{
					...
					{
						Name:        "antispam.anti_invite",
						Label:       asInviteL,
						Description: asInviteD,
						Type:        core.ComponentTypeBoolean,
					},
					{
						Name:        "antispam.anti_mention",
						Label:       asMentionL,
						Description: asMentionD,
						Type:        core.ComponentTypeBoolean,
					},
					{
						Name:        "antispam.anti_mass_emoji",
						Label:       asEmojiL,
						Description: asEmojiD,
						Type:        core.ComponentTypeBoolean,
					},
					{
						Name:        "antispam.anti_zalgo",
						Label:       asZalgoL,
						Description: asZalgoD,
						Type:        core.ComponentTypeBoolean,
					},
					{
						Name:        "antispam.ignored_channels",
						Label:       asIgnoredL,
			...
			},
			{
				...
				Components: []core.UIComponent{
					{
						Name:        "antinuke.anti_mass_kick",
						Label:       anKickL,
						Description: anKickD,
						Type:        core.ComponentTypeBoolean,
					},
					{
						Name:        "antinuke.anti_mass_channel_delete",
						Label:       anChanL,
						Description: anChanD,
						Type:        core.ComponentTypeBoolean,
					},
					{
						Name:        "antinuke.anti_mass_role_delete",
						Label:       anRoleL,
						Description: anRoleD,
						Type:        core.ComponentTypeBoolean,
					},
					{
						Name:        "antinuke.anti_vanity_url_edit",
						Label:       anUrlL,
						Description: anUrlD,
						Type:        core.ComponentTypeBoolean,
					},
					{
						Name:        "antinuke.anti_danger_permission",
						Label:       anPermL,
						Description: anPermD,
						Type:        core.ComponentTypeBoolean,
					},
